...
export default {
    mounted() {
        ...
        tl.fromTo('.about-bitext', {opacity:0}, {opacity: 1, duration: 1, stagger: 0.25},'=-0.75')
...
<style>
  ...
  /*src\assets\tudor-baciu-vc3iVL_znJ8-unsplash.jpg  */

  .about-landing{
      position: relative;
      background: url('../assets/tudor-baciu-vc3iVL_znJ8-unsplash.jpg');
