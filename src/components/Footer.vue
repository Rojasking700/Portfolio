<template>
    <footer>
        ...
        <div class="lets-talk">
            ...
            <router-link class="footer-btn" :to="{name: 'Contact'}" @click="scrollToTop()">Contact Me</router-link>
        </div>
...
.effect a {
  ...
  border: 2px solid rgb(61, 216, 255);
}
.effect a i {
  position: relative;
  z-index: 3;
...
.effect.thurio a:hover {
  border-radius: 0px;
  box-shadow: 0px 0px 16px 4px rgba(61, 216, 255, 1);
